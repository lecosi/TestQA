...
class Ayjue(unittest.TestCase):
    ...
    def test_ayjue(self):
        ...
        Select(driver.find_element_by_id("models")).select_by_visible_text("2013")
        ...
        driver.find_element_by_id("mobile_phone").send_keys("3156244272")
